...
export function Customers() {
  ...
  function load(targetPage = page) {
    setIsLoading(true);
    fetchCustomers({ q: search || undefined, page: targetPage })
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <label className="flex-1 min-w-[220px]">
          ...
          <div className="flex gap-2">
            ...
            />
            <button onClick={handleSearch} className="rounded-lg border border-ink/10 px-4 py-2 text-sm text-ink hover:bg-paper-dim">
              Search
            </button>
          </div>
        </label>
