...
class TestimonialSeeder extends Seeder
{
    ...
    {
        $testimonials = [
            ['Nimasha Perera', 'Complete Bridal Package', 5, 'Shanika and her team made my wedding morning so calm. My hair held up through the whole beach ceremony and photos afterwards. I felt completely like myself, just more polished.', '2026-05-12'],
            ...
            ['Sanduni Rathnayake', 'Classic Facial', 5, 'My go-to facial before any event. The salon always feels clean, relaxed, and Shanika remembers exactly what my skin needs each visit.', '2026-02-14'],
