...
<title>@yield('title', 'Salon Belinda')</title>
</head>
                ...
                <tr>
                    <td style="padding: 20px 32px; border-top: 1px solid rgba(36,26,33,0.1);">
                        <p style="margin:0; font-size: 12px; color:#241A21; opacity:0.6;">
                            {{ $siteAddress ?? '82 Havelock Rd, Galle 80000, Sri Lanka' }}<br>
                            {{ $sitePhone ?? '070 244 4393' }} &middot; {{ $siteEmail ?? 'info.salonbelinda@gmail.com' }}
                        </p>
                    </td>
                </tr>
            </table>
